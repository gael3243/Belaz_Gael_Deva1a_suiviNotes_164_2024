...
try:
    ...
    """
    from APP_FILMS_164.type_matiere import gestion_type_matiere_crud
    from APP_FILMS_164.type_matiere import gestion_type_matiere_wtf_forms

    from APP_FILMS_164.matiere import gestion_matiere_crud
    from APP_FILMS_164.matiere import gestion_matiere_wtf_forms

    from APP_FILMS_164.type_notes import gestion_type_notes_crud
    from APP_FILMS_164.type_notes import gestion_type_notes_wtf_forms

    from APP_FILMS_164.Suivi import gestion_suivi_crud
    from APP_FILMS_164.Suivi import gestion_suivi_wtf_forms

    from APP_FILMS_164.notes import gestion_notes_crud
    from APP_FILMS_164.notes import gestion_notes_wtf_forms
